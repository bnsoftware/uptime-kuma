        ...
        <div :class="{ edit: enableEditMode}" class="main">
            ...
            <h1 class="mb-4 title-flex">
                ...
                <span class="logo-wrapper" @click="showImageCropUploadMethod">
                    <img src="/logo-som.png" alt="Screencast-O-Matic | ScreenPal" class="logo me-2" :class="logoClass" height="60" @load="statusPageLogoLoaded" />
                ...
                <!-- Title -->
                <Editable v-model="config.title" tag="span" :contenteditable="editMode" :noNL="true" class="hidden" />
            </h1>
            ...
            <footer class="mt-5 mb-4">
                ...
                <p v-if="config.showPoweredBy" class="hidden">
